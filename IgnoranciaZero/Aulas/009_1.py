'''
UMA LATA TEM 18 LITROS E COBRE 108 METROS
LATA = R$ 80

UM GALÂO TEM 4 LITROS E COBRE 24 METROS
GALÃO = R$ 25



tamanhoEmMetros=int(input("Informe quantos metros: "));
quantidadeDeLitros=tamanhoEmMetros//6;
latasDeTinta=quantidadeDeLitros//18;
galaoDeTintas=latasDeTinta%18;
'''
"""
